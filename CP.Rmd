...
The accuracy is 99%! This is suspiciously high. As a result our in sample error is just 1%. Scoring such high accuracy makes the out of sample error (which is higher than the in sample error by definition) very interesting. We expect our out of sample error to be slightly higher for this model Let's first try a third model and see how that works. We opt for a Naive Bayes model, let's train it again!
